...
type ITCStatus = 'eligible' | 'pending' | 'blocked' | 'deferred'
...
interface ITCRow {
  ...
  period: string
  status: ITCStatus
  variance?: number       // Matched — PR ITC minus 2B ITC (paise)
  blockReason?: string    // Blocked rows (Sec 17(5))
  mismatchReason?: string // Pending rows
  deferReason?: string    // Deferred / 2B-only rows
}
...
const MOCK: ITCRow[] = [
  // Matched → eligible
  { id: 'm1', gstin: '27AABCU9603R1ZX', supplierName: 'Reliance Industries Ltd',        invoiceNo: 'RI/2026/00841', invoiceDate: '05 Mar 2026', invoiceValue: 118000, taxableValue: 100000, igst: 18000, cgst: 0,    sgst: 0,    totalITC: 18000, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },
  { id: 'm2', gstin: '29AADCB2230M1ZP', supplierName: 'Infosys BPO Ltd',                invoiceNo: 'INF/B/2642',   invoiceDate: '07 Mar 2026', invoiceValue: 59000,  taxableValue: 50000,  igst: 9000,  cgst: 0,    sgst: 0,    totalITC: 9000,  source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },
  { id: 'm3', gstin: '06AAACR5055K1ZM', supplierName: 'Maruti Suzuki India Ltd',         invoiceNo: 'MSI/T/00229',  invoiceDate: '09 Mar 2026', invoiceValue: 295000, taxableValue: 250000, igst: 0,     cgst: 22500, sgst: 22500, totalITC: 45000, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },
  { id: 'm4', gstin: '24AAACL1234Q1ZV', supplierName: 'Larsen & Toubro Ltd',             invoiceNo: 'LT/GST/10234', invoiceDate: '10 Mar 2026', invoiceValue: 472000, taxableValue: 400000, igst: 72000, cgst: 0,    sgst: 0,    totalITC: 72000, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 200 },
  { id: 'm5', gstin: '07AABCT3518Q1ZO', supplierName: 'Tata Consultancy Services',       invoiceNo: 'TCS/I/78321',  invoiceDate: '12 Mar 2026', invoiceValue: 141600, taxableValue: 120000, igst: 21600, cgst: 0,    sgst: 0,    totalITC: 21600, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },
  { id: 'm6', gstin: '19AAACI1208Q1ZF', supplierName: 'ITC Limited',                     invoiceNo: 'ITCL/P/5510',  invoiceDate: '14 Mar 2026', invoiceValue: 35400,  taxableValue: 30000,  igst: 5400,  cgst: 0,    sgst: 0,    totalITC: 5400,  source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },
  { id: 'm7', gstin: '27AAACM4082G1ZM', supplierName: 'Mahindra & Mahindra Ltd',         invoiceNo: 'M&M/V/00632',  invoiceDate: '15 Mar 2026', invoiceValue: 189600, taxableValue: 160000, igst: 0,     cgst: 14400, sgst: 14400, totalITC: 28800, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: -150 },
  { id: 'm8', gstin: '29AAACW0912H1Z5', supplierName: 'Wipro Technologies Ltd',          invoiceNo: 'WIP/S/33210',  invoiceDate: '16 Mar 2026', invoiceValue: 94400,  taxableValue: 80000,  igst: 14400, cgst: 0,    sgst: 0,    totalITC: 14400, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'eligible', variance: 0 },

  // Unmatched → blocked (Sec 17(5))
  { id: 'b1', gstin: '07AABCZ8788M1ZO', supplierName: 'Zomato Ltd',                     invoiceNo: 'ZOM/I/44021',  invoiceDate: '02 Mar 2026', invoiceValue: 23600,  taxableValue: 20000,  igst: 3600,  cgst: 0,    sgst: 0,    totalITC: 3600,  source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'blocked', blockReason: 'Sec 17(5)(b) — Club/canteen' },
  { id: 'b2', gstin: '06AAACR5055K1ZX', supplierName: 'Maruti Suzuki (Car Lease)',       invoiceNo: 'MSI/L/00104',  invoiceDate: '04 Mar 2026', invoiceValue: 94400,  taxableValue: 80000,  igst: 14400, cgst: 0,    sgst: 0,    totalITC: 14400, source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'blocked', blockReason: 'Sec 17(5)(a) — Motor vehicles' },
  { id: 'b3', gstin: '24AAACH1234Q1ZV', supplierName: 'HDFC ERGO Insurance',             invoiceNo: 'HDFC/H/22044', invoiceDate: '05 Mar 2026', invoiceValue: 17700,  taxableValue: 15000,  igst: 2700,  cgst: 0,    sgst: 0,    totalITC: 2700,  source2B: true, sourceBooks: true, period: 'Mar 2026', status: 'blocked', blockReason: 'Sec 17(5)(c) — Health insurance' },

  // Unmatched → pending (2B mismatch)
  { id: 'u1', gstin: '33AACCP3304M1ZC', supplierName: 'Cognizant Technology Solutions', invoiceNo: 'CTS/IN/92101', invoiceDate: '03 Mar 2026', invoiceValue: 177000, taxableValue: 150000, igst: 27000, cgst: 0,    sgst: 0,    totalITC: 27000, source2B: false, sourceBooks: true,  period: 'Mar 2026', status: 'pending', mismatchReason: 'Not reported in GSTR-2B' },
  { id: 'u2', gstin: '27AABCS4989K1ZR', supplierName: 'Sun Pharmaceutical Industries',  invoiceNo: 'SPI/B/7710',   invoiceDate: '08 Mar 2026', invoiceValue: 59000,  taxableValue: 50000,  igst: 9000,  cgst: 0,    sgst: 0,    totalITC: 9000,  source2B: true,  sourceBooks: true,  period: 'Mar 2026', status: 'pending', mismatchReason: 'Tax amount mismatch' },
  { id: 'u3', gstin: '24AAACP3304N1ZN', supplierName: 'Asian Paints Ltd',               invoiceNo: 'AP/GST/3312',  invoiceDate: '11 Mar 2026', invoiceValue: 47200,  taxableValue: 40000,  igst: 7200,  cgst: 0,    sgst: 0,    totalITC: 7200,  source2B: false, sourceBooks: true,  period: 'Mar 2026', status: 'pending', mismatchReason: 'Not reported in GSTR-2B' },
  { id: 'u4', gstin: '29AABCH4259Q1ZM', supplierName: 'HCL Technologies Ltd',           invoiceNo: 'HCL/S/28840',  invoiceDate: '17 Mar 2026', invoiceValue: 70800,  taxableValue: 60000,  igst: 10800, cgst: 0,    sgst: 0,    totalITC: 10800, source2B: true,  sourceBooks: true,  period: 'Mar 2026', status: 'pending', mismatchReason: 'GSTIN mismatch' },

  // 2B Only → deferred
  { id: 'd1', gstin: '27AABCF8878P1ZQ', supplierName: 'Future Retail Ltd',              invoiceNo: 'FRL/T/20091',  invoiceDate: '01 Mar 2026', invoiceValue: 82600,  taxableValue: 70000,  igst: 12600, cgst: 0,    sgst: 0,    totalITC: 12600, source2B: true, sourceBooks: false, period: 'Mar 2026', status: 'deferred', deferReason: 'Invoice not booked — supplier amendment pending' },
  { id: 'd2', gstin: '24AABCB4780H1Z5', supplierName: 'Bajaj Finserv Ltd',              invoiceNo: 'BFS/I/61023',  invoiceDate: '04 Mar 2026', invoiceValue: 35400,  taxableValue: 30000,  igst: 5400,  cgst: 0,    sgst: 0,    totalITC: 5400,  source2B: true, sourceBooks: false, period: 'Mar 2026', status: 'deferred', deferReason: 'Supplier GSTIN cancelled' },
  { id: 'd3', gstin: '07AABCA1234H1ZT', supplierName: 'Amazon Seller Services Pvt Ltd', invoiceNo: 'ASS/P/99201',  invoiceDate: '06 Mar 2026', invoiceValue: 141600, taxableValue: 120000, igst: 21600, cgst: 0,    sgst: 0,    totalITC: 21600, source2B: true, sourceBooks: false, period: 'Mar 2026', status: 'deferred', deferReason: 'Invoice date > 3 years' },
  { id: 'd4', gstin: '29AABCF3940Q1ZX', supplierName: 'Flipkart Internet Pvt Ltd',      invoiceNo: 'FKT/M/55432',  invoiceDate: '08 Mar 2026', invoiceValue: 59000,  taxableValue: 50000,  igst: 9000,  cgst: 0,    sgst: 0,    totalITC: 9000,  source2B: true, sourceBooks: false, period: 'Mar 2026', status: 'deferred', deferReason: 'Pending supplier amendment' },
  { id: 'd5', gstin: '06AABCK2340R1ZW', supplierName: 'Kotak Mahindra Bank Ltd',        invoiceNo: 'KMB/C/44812',  invoiceDate: '10 Mar 2026', invoiceValue: 23600,  taxableValue: 20000,  igst: 3600,  cgst: 0,    sgst: 0,    totalITC: 3600,  source2B: true, sourceBooks: false, period: 'Mar 2026', status: 'deferred', deferReason: 'Supplier GSTIN cancelled' },
]
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 0 10px' }}>
        ...
        {/* Status filter (only for unmatched where two sub-statuses exist) */}
        {statuses.length > 1 && (
          <select
            value={statusFilter}
      ...
      <div style={{ background: '#fff', border: '0.5px solid #dde0cc', borderRadius: 10, overflow: 'hidden' }}>
        {filtered.length === 0 ? (
          <div style={{ padding: '56px 24px', textAlign: 'center' as const }}>
            <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#f2f3eb', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px' }}>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <circle cx="8" cy="8" r="6" stroke="#9aa090" strokeWidth="1.3"/>
                <path d="M13 13l3 3" stroke="#9aa090" strokeWidth="1.3" strokeLinecap="round"/>
              </svg>
            </div>
...
const PERIODS = ['Mar 2026', 'Feb 2026', 'Jan 2026', 'Dec 2025']
...
export default function ITCPage() {
  ...
  const allRows = useMemo(() => MOCK.filter(r => r.period === period), [period])

  const counts = {
    matched:   tabRows('matched',   allRows).length,
    unmatched: tabRows('unmatched', allRows).length,
    '2b_only': tabRows('2b_only',   allRows).length,
  }

  const eligible = useMemo(() => allRows.filter(r => r.status === 'eligible'), [allRows])
  ...
  function handleCopy({ igst, cgst, sgst, total }: { igst: number; cgst: number; sgst: number; total: number }) {
    try {
      localStorage.setItem('itc_push_latest', JSON.stringify({ igst, cgst, sgst, total, period, pushedAt: new Date().toISOString() }))
    } catch { /* ignore */ }
    setPushed(true)
    toast(`ITC ${fmtShort(total)} pushed to GSTR-3B Table 4(A)`, '↗')
  }

  function handleExport(rows: ITCRow[]) {
    exportCSV(rows, TC[tab].label, period)
    toast(`${TC[tab].label} exported — ${rows.length} rows`, '↓')
  }
    ...
    <div style={{ padding: '32px 32px', maxWidth: 1300, fontFamily: 'var(--font-geist-sans, sans-serif)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <select
            value={period}
            onChange={e => { setPeriod(e.target.value); setPushed(false) }}
            style={{
              fontSize: 13, color: '#1e2118', background: '#fff',
              border: '0.5px solid #dde0cc', borderRadius: 8,
      ...
      <div style={{ marginTop: 16, display: 'flex', alignItems: 'center', gap: 20, fontSize: 11, color: '#9aa090' }}>
        ...
        <div style={{ flex: 1 }} />
        <span>Source: GSTR-2B + Purchase Register · {period}</span>
      </div>
